...
namespace Fragsurf.Movement {
    ...
    public class SurfCharacter : MonoBehaviour, ISurfControllable {
        ...
        private SurfCharacter getInstance(){
            return this;
        }
        ...
        private void Update () {
            ...
            //TODO remove later
            //Debugging for raycasts

            //Forward raycast
            Debug.DrawRay(transform.position, 5 * Vector3.forward, Color.green);
            //Up
            Debug.DrawRay(transform.position, 5 * Vector3.up, Color.green);
            //Down
            Debug.DrawRay(transform.position, 5 * Vector3.down, Color.green);
            //Left
            Debug.DrawRay(transform.position, 5 * Vector3.left, Color.green);
            //Right
            Debug.DrawRay(transform.position, 5 * Vector3.right, Color.green);
            //Upper Left Quad
            Debug.DrawRay(transform.position, 5 * (Vector3.forward + Vector3.left + Vector3.up).normalized, Color.green);
            //Upper Right Quad
            Debug.DrawRay(transform.position, 5 * (Vector3.forward + Vector3.right + Vector3.up).normalized, Color.green);
            //Lower Left Quad
            Debug.DrawRay(transform.position, 5 * (Vector3.forward + Vector3.left + Vector3.down).normalized, Color.green);
            //Lower Right Quad
            Debug.DrawRay(transform.position, 5 * (Vector3.forward + Vector3.right + Vector3.down).normalized, Color.green);
        ...
        private void UpdateMoveData () {
            ...
            //transform.Rotate(0f, prevAngle - changeAngle, 0f);
            //Quaternion target = Quaternion.Euler(prevAngle - changeAngle, 0, 0);
            //float smooth = 1f;
            //transform.rotation = Quaternion.Slerp(transform.rotation, target, Time.deltaTime * smooth);
            //prevAngle = prevAngle - changeAngle;
